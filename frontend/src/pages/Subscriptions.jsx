          ...
          <Stack direction={{ xs: "column", lg: "row" }} spacing={3} justifyContent="space-between">
            <Box sx={{ maxWidth: 760 }}>
              ...
              <Typography sx={{ mt: 1.5, color: "rgba(255,246,239,0.82)", maxWidth: 680 }}>
                Keep track of the creators you follow and jump back into their latest uploads
                from one clean subscription view.
              </Typography>
            </Box>
                ...
                <Stack spacing={1.2}>
                  ...
                  {notifications.length === 0 && (
                    <Typography sx={{ color: "rgba(255,255,255,0.72)" }}>
                      New uploads and creator updates will appear here.
                    </Typography>
                  )}
                </Stack>
              </CardContent>
